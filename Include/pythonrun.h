...
#ifdef _WIN32
PyAPI_FUNC(char *) Py_GetPrivateDLLsPath(void);
PyAPI_FUNC(int) Py_SetPrivateDLLsPath(char *);
#endif

/* In their own files */
PyAPI_FUNC(const char *) CUSTOM_tools_path(void);
PyAPI_FUNC(const char *) CUSTOM_GetVersion(void);
