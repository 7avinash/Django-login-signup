...
/*
 * The API required for private dll support require Windows XP SP 2 or above.
 *
 * Since we don't support anything below that, resetting both Py_WINVER and
 * Py_NTDDI for both the interpreter and extensions should be fine.
 */
#undef Py_WINVER
#undef Py_NTDDI

/* Note: _WIN32_WINNT_WS03 refers to both Server 2003 AND XP SP 2 */
#define Py_WINVER _WIN32_WINNT_WS03
#define Py_NTDDI NTDDI_WS03

/*
 * end of Enthought-specific changes
 */
